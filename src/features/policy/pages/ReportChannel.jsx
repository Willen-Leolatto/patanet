    ...
    <div className="mx-auto w-full max-w-3xl">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
          Você pode denunciar conteúdos/usuários diretamente no app. Use o botão Denunciar no feed ou no perfil do usuário. Se você não conseguir acessar o app, use a opção por e-mail abaixo.
        </p>
      </header>
      ...
      <section className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-200">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>No feed: toque nos  pontinhos do post  e escolha <em>Denunciar</em> ou <em>CSAE</em>.</li>
            <li>No perfil do usuário: toque em <em>Denunciar</em> ou <em>CSAE</em>.</li>
          </ul>
        </div>
        ...
        <div className="mt-2 grid gap-2 text-sm">
          ...
          <Link className="inline-flex items-center gap-2 text-[#f77904] hover:underline" to="/usuarios">
            <User className="h-4 w-4" /> Voltar para explorar usuários
          </Link>
        </div>
