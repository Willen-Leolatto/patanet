    ...
    <div className="mx-auto w-full max-w-3xl">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
          Resumo em linguagem simples sobre como o PataNet lida com dados pessoais e conteúdo gerado por usuários.
        </p>
      </header>
      ...
      <section className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="text-sm text-zinc-700 dark:text-zinc-200">
          Aplicativo: <b>PataNet</b>. Contato para privacidade e dados: <b>{PRIVACY_EMAIL}</b>.
        </p>
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-zinc-700 dark:text-zinc-200">
          <li>
            <b>Conta/perfil:</b> nome/usuário, e-mail, foto, bio e preferências básicas.
          </li>
          <li>
            <b>Conteúdo do usuário (UGC):</b> posts, comentários, imagens, denúncias e metadados (datas/IDs necessários para operar e moderar).
          </li>
          <li>
            <b>Dados técnicos e de segurança:</b> logs de erro, IP/logs no servidor, identificadores internos e sinais anti-abuso.
          </li>
        </ul>

        <h2 className="text-lg font-semibold">3) Como usamos esses dados</h2>
        <ul className="list-disc space-y-2 pl-5 text-sm text-zinc-700 dark:text-zinc-200">
          <li>Operar o serviço (feed, eventos, perfis, criação e exibição de conteúdo).</li>
          <li>Autenticação e segurança (prevenção de fraude/abuso, proteção da comunidade).</li>
          <li>Moderação e conformidade com políticas (incluindo segurança infantil/CSAE).</li>
        ...
        <p className="text-sm text-zinc-700 dark:text-zinc-200">
          Podemos compartilhar dados com provedores necessários para operar o serviço (infra/armazenamento) e quando exigido por lei ou para proteger
        ...
        <h2 className="text-lg font-semibold">6) Seus direitos e solicitações</h2>
        <p className="text-sm text-zinc-700 dark:text-zinc-200">
